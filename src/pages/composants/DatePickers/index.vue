      ...
      <ka-container code="sous-main">
        ...
        <ka-container code="api">
          <ka-text code="api-text">
            <h2 v-html="t('datePickers.main.sousMain.api.apiText.value', `<span style='background-color:rgb(255,255,255);color:rgba(0,0,0,0.87);'>Examples</span>`)" />
          </ka-text>
        </ka-container>
        <!-- Exemple -->
          ...
          <ka-container code="proprietes">
            ...
            <ka-container code="formatting">
              <ka-text code="formatting-with-external">
                <span v-html="t('datePickers.main.sousMain.exemple.proprietes.formatting.formattingWithExternal.value', `<span style='font-size:21px;'><strong>Formatting with external libraries</strong></span><br>Formatting dates is possible also with external libs such as Moment.js or date-fns`)" />
              </ka-text>
              <!-- Formatting -->
              <ka-container code="formatting-container">
                <ka-date-picker-input
                  ...
                  :options="{
                    ...
                    placeholder: t('datePickers.main.sousMain.exemple.proprietes.formatting.formattingContainer.saisieDeDate.placeholder', `Saisie de date`)
                  }" />
                <ka-date-picker-input
                  ...
                  :options="{
                    ...
                    placeholder: t('datePickers.main.sousMain.exemple.proprietes.formatting.formattingContainer.saisieDeDateDatePicker.placeholder', `Saisie de date`)
                  }" />
                <ka-date-picker-input
                  ...
                  :options="{
                    dateFormat: `birthday`,
                    placeholder: t('datePickers.main.sousMain.exemple.proprietes.formatting.formattingContainer.saisieDeDate1.placeholder', `Saisie de date`)
                  }" />
                <ka-date-picker-input
                  ...
                  :options="{
                    dateFormat: null,
                    placeholder: t('datePickers.main.sousMain.exemple.proprietes.formatting.formattingContainer.saisieDeDate2.placeholder', `Saisie de date`)
                  }" />
              </ka-container>
            </ka-container>
            <ka-code-preview
      ...
      <ka-container code="sous-nav">
        ...
        <ka-container code="container">
          <ka-text code="contenu">
            <span v-html="t('datePickers.rightPanel.sousNav.container.contenu.value', `Contenu`)" />
          </ka-text>
        </ka-container>
        <!-- Container 1 -->
        <ka-container code="container-1">
          <ka-text
            ...
            <span v-html="t('datePickers.rightPanel.sousNav.container1.titreText.value', `Utilisation`)" />
          </ka-text>
          <ka-text
            code="titre-1"
            :options="{
            ...
            :selected="{ style: { borderColor: appData.theme.primaryColor } }">
            <span v-html="t('datePickers.rightPanel.sousNav.container1.titre1.value', `API`)" />
          </ka-text>
          <ka-text
            code="titre-2"
            :options="{
            ...
            :selected="{ style: { borderColor: appData.theme.primaryColor } }">
            <span v-html="t('datePickers.rightPanel.sousNav.container1.titre2.value', `Exemples`)" />
          </ka-text>
          <!-- sous-categorie -->
          <ka-container code="sous-categorie">
            <ka-text
              ...
              :selected="{ style: { borderColor: appData.theme.primaryColor } }">
              <span v-html="t('datePickers.rightPanel.sousNav.container1.sousCategorie.sousTitre.value', `Propriétés`)" />
            </ka-text>
            <!-- sous-sous-categorie -->
            <ka-container code="sous-sous-categorie">
              <ka-text
                ...
                :selected="{ style: { borderColor: appData.theme.primaryColor } }">
                <span v-html="t('datePickers.rightPanel.sousNav.container1.sousCategorie.sousSousCategorie.sousTitreText.value', `Couleurs`)" />
              </ka-text>
              <ka-text
                code="sous-titre-1"
                :options="{
                ...
                :selected="{ style: { borderColor: appData.theme.primaryColor } }">
                <span v-html="t('datePickers.rightPanel.sousNav.container1.sousCategorie.sousSousCategorie.sousTitre1.value', `Formatting`)" />
              </ka-text>
            </ka-container>
          </ka-container>
        </ka-container>
...
const page = syncPageStore(headerWithLeftSidebarDatePickers())
// SEO
if (props.seo) {
